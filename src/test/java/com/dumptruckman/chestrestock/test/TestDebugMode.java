...
package com.dumptruckman.simplecircuits.test;
...
import com.dumptruckman.simplecircuits.api.CircuitsPlugin;
...
import com.dumptruckman.simplecircuits.test.utils.TestInstanceCreator;

@RunWith(PowerMockRunner.class)
@PrepareForTest({ SimpleCircuitsPlugin.class })
public class TestDebugMode {
    ...
    public void testEnableDebugMode() {
        ...
        CircuitsPlugin myPlugin = (CircuitsPlugin) plugin;
