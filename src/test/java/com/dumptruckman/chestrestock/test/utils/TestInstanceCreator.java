...
package com.dumptruckman.simplecircuits.test.utils;
...
import com.dumptruckman.simplecircuits.util.FileUtils;
...
public class TestInstanceCreator {
    private SimpleCircuitsPlugin plugin;
    ...
    public boolean setUp() {
        try {
            ...
            plugin = PowerMockito.spy(new SimpleCircuitsPlugin());
            ...
            PluginDescriptionFile pdf = new PluginDescriptionFile("SimpleCircuits", "dev",
                    "com.dumptruckman.simplecircuits.SimpleCircuits");
    ...
    public SimpleCircuitsPlugin getPlugin() {
        return this.plugin;
    }
